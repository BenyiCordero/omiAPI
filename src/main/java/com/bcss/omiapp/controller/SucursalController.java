...
public class SucursalController {
    ...
    public ResponseEntity<?> getById(@PathVariable Integer id) {
        return ResponseEntity.status(HttpStatus.OK).body(sucursalService.getByIdDetail(id));
    }

    @GetMapping
    public ResponseEntity<?> getAll() {
        return ResponseEntity.status(HttpStatus.OK).body(sucursalService.getAllList());
    }

    @GetMapping("/nombre")
    public ResponseEntity<?> getByName(@RequestParam String nombre) {
        return ResponseEntity.status(HttpStatus.OK).body(sucursalService.findByName(nombre));
    }
