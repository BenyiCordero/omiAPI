...
public class SecurityConfig {
    ...
    private final JwtAuthenticationFiter jwtAuthenticationFilter;
    private final AuthenticationProvider authenticationProvider;
    private final TokenService tokenService;

    public SecurityConfig(JwtAuthenticationFiter jwtAuthenticationFilter, AuthenticationProvider authenticationProvider, TokenService tokenService) {
